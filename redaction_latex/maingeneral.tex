...
\newcommand{\safeimage}[4][0.85\textwidth]{%
  % If called inside a float (\@captype defined), do not create a new figure;
  % otherwise, wrap content in a figure environment.
  \@ifundefined{@captype}{%
    \begin{figure}[H]
      \centering
      \IfFileExists{#2}{%
    ...
    % Inside an existing float: just include the graphic and caption/label
    \centering
    \IfFileExists{#2}{%
      \includegraphics[width=#1]{#2}%
    }{%
...
\textit{À nos chers parents qui nous ont fourni au quotidien un soutien et une confiance inébranlable, nous ne saurions exprimer toute notre gratitude avec de simples mots}
\medskip

\textit{À tous les membres de nos familles respectives}
\medskip

\textit{À tous nos amis}
\medskip

\textit{À tous nos enseignants pour leur soutien, leurs enseignements et leurs conseils tout au long de notre parcours éducatif.}
\end{center}
\vspace{1cm}
\clearpage
...
\begin{center}
\large
    \textit{Nous tenons avant toute chose, à remercier DIEU et à lui rendre grâce pour la force et le courage qu'il nous a donnés et qui nous ont permis de surmonter tous les obstacles rencontrés durant la réalisation de ce travail et de le mener à son terme.}
    
    \medskip
    \textit{À nos chers parents, pour tous leurs sacrifices, leurs amours, leurs soutiens et leurs prières tout au long de nos études.}
    
    \medskip
    \textit{On tient à remercier notre encadrante Mme GUERROUDJI qui nous a accompagné tout au long de ce travail; on lui adresse toute notre gratitude pour sa patience.}
    
    \medskip
    \textit{Nos remerciements vont aussi à Mme MEKKAKIA et Mme HERNANE, nos examinatrices, pour leur soutien et leurs évaluations constructives.}
\end{center}
\clearpage
\pagenumbering{roman}
\tableofcontents
...
La transformation num\'erique des syst\`emes d’enseignement constitue aujourd’hui une priorit\'e strat\'egique pour les \'etablissements confront\'es \`a la massification des effectifs, \`a la diversification des parcours et \`a l’exigence croissante de qualit\'e p\'edagogique. Dans ce contexte, la mise en place de plateformes num\'eriques ne peut plus se limiter \`a la simple diffusion de supports de cours : elle doit int\'egrer la gouvernance acad\'emique, la collaboration entre acteurs et la tra\c{c}abilit\'e des activit\'es.

Le projet \textbf{TAMKIN} (\textit{\textbf{T}ake \textbf{A} \textbf{M}oment for \textbf{K}nowledge \textbf{I}n \textbf{N}ew ways}) s’inscrira pleinement dans cette dynamique. Il vise \`a proposer une plateforme unifi\'ee de partage p\'edagogique et de collaboration, id\'ealement adapt\'ee aux \'etablissements, en combinant : gestion stricte par r\^oles, structuration m\'ethodique des ressources par niveau/module/composant, outils de communication synchrone et asynchrone, ainsi que des modules de pilotage administratifs.

\paragraph{Probl\'ematique g\'en\'erale.} --- Comment concevoir une plateforme \'educative \`a la fois robuste techniquement, pertinente p\'edagogiquement et viable \'economiquement, capable d’unifier les usages quotidiens des apprenants, formateurs et responsables d’\'etablissement ?

\paragraph{Objectif global.} --- Concevoir, impl\'ementer et \'evaluer TAMKIN comme solution compl\`ete pour les \'ecoles et centres de formation, puis proposer un cadre formel de passage \`a l’\'echelle startup \`a travers un mod\`ele \'economique viable et une strat\'egie de croissance r\'esiliente.

\paragraph{Organisation du m\'emoire.} --- Ce m\'emoire est structur\'e en quatre chapitres progressifs :
\begin{itemize}
  \item \textbf{Chapitre 1 :} \'Etude de contexte et probl\'ematiques ;
  \item \textbf{Chapitre 2 :} Conception UML et architecture de la solution ;
  \item \textbf{Chapitre 3 :} Impl\'ementation technique, d\'eploiement et validation ;
  \item \textbf{Chapitre 4 :} \'Evaluation strat\'egique et business model (cadre startup, loi 12-75).
\end{itemize}

L’encha\^inement rigoureux de ces chapitres permet de relier de mani\`ere progressive la pertinence scientifique du projet, sa r\'ealisation concr\`ete sur le terrain et sa projection entrepreneuriale future.

%% ═══════════════════════════════════════════════════════════════════════════════
%% CHAPITRE 1 — Contexte général, problématique et état de l'art
%% ═══════════════════════════════════════════════════════════════════════════════
\chapter{Etude de contexte et problématique}

%%──────────────────────────────────────────────────────────────────────────────
\section{Introduction du chapitre}
%%──────────────────────────────────────────────────────────────────────────────

La g\'en\'eralisation des technologies num\'eriques dans l'enseignement et la formation constitue aujourd'hui l'un des leviers strat\'egiques les plus significatifs pour l'am\'elioration de la qualit\'e p\'edagogique, la continuit\'e des activit\'es et l'inclusion \'educative. Dans ce contexte de mutation profonde, les établissements sont confrontés à un impératif d'adaptation organisationnelle et technologique, auquel répondent des environnements numériques de plus en plus sophistiqu\'es~\cite{unesco_digital_2026,worldbank_edtech_2026}.

Le pr\'esent chapitre constitue le socle analytique et conceptuel du projet \textbf{TAMKIN}. Il poursuit quatre objectifs compl\'ementaires~: (i)~d\'ecrire le contexte mondial et national de la transformation num\'erique de l'enseignement~; (ii)~formuler la probl\'ematique ayant motiv\'e la conception de TAMKIN~; (iii)~pr\'esenter les objectifs et la m\'ethodologie adopt\'es~; et (iv)~dresser un \'etat de l'art approfondi des solutions existantes, afin de positionner TAMKIN par rapport aux r\'ef\'erences du domaine.

Ce chapitre est organis\'e comme suit~: la section~\ref{sec:contexte} traite du contexte g\'en\'eral~; la section~\ref{sec:problematique} formule la probl\'ematique~; la section~\ref{sec:objectifs} d\'etaille les objectifs~; la section~\ref{sec:methodo} pr\'esente la d\'emarche m\'ethodologique~; la section~\ref{sec:etat_art} constitue l'\'etat de l'art~; la section~\ref{sec:positionnement} positionne TAMKIN~; enfin, la section~\ref{sec:conclusion} conclut le chapitre.
...
L'objectif g\'en\'eral du projet est de concevoir, d\'evelopper et valider \textbf{TAMKIN}~: une plateforme web de partage p\'edagogique et de collaboration éducative, con\c{c}ue pour les usages des etablissements, et structur\'ee autour d'une architecture orient\'ee modules, d'un syst\`eme de gouvernance par r\^oles et d'une couche sociale int\'egr\'ee.
...
\begin{itemize}
  ...
  \item[\textbf{OS2.}] Mettre en \oe uvre un syst\`eme d'authentification s\'ecuris\'e par jetons JWT et une autorisation par r\^oles~: Administrateur super, Administrateur d'etablissement, Formateur principale, Formateur simple et Utilisateur.
  \item[\textbf{OS3.}] Int\'egrer un espace de communication structur\'e~: chat priv\'e et de groupe, notifications et publication de ressources p\'edagogiques.
...
\begin{enumerate}
  \item \textbf{Analyse des besoins}~: identification des besoins fonctionnels et non fonctionnels.
...
\begin{itemize}
  ...
  \item TAMKIN est la seule solution \textbf{auto-h\'eberg\'ee} et \textbf{contexte-native}~: chaque fonctionnalit\'e a \'et\'e con\c{c}ue en r\'eponse directe \`a un besoin identifi\'e dans un contexte éducatif local.
  \item Le tableau~\ref{tab:compar_detail} ci-dessous approfondit l'analyse sur \textbf{12 crit\`eres fonctionnels et techniques}, permettant de mesurer pr\'ecis\'ement les apports sp\'ecifiques de TAMKIN.
\end{itemize}
\end{tcolorbox}
\medskip

%%──────────────────────────────────────────────────────────────────────────────
\subsection{Tableau~2~---~Analyse comparative d\'etaill\'ee (7 crit\`eres)}
%%──────────────────────────────────────────────────────────────────────────────

Le tableau~\ref{tab:compar_detail} confronte les plateformes de r\'ef\'erence mondiales \`a notre solution sur sept crit\`eres strat\'egiques, couvrant les dimensions fonctionnelles, techniques, linguistiques et \'economiques sp\'ecifiques au march\'e vis\'e.
...
\caption{Analyse comparative d\'etaill\'ee des plateformes p\'edagogiques num\'eriques (7 crit\`eres)}
...
\textcolor{white}{\textbf{EduPlatform (TAMKIN)}} \\
\hline
\endfirsthead

%% ── EN-TÊTE PAGES SUIVANTES ────────────────────────────────────────────
\multicolumn{4}{l}{\small\textit{(suite du tableau~\ref{tab:compar_detail})}} \\[2pt]
\hline
\rowcolor{ustoblue}
\textcolor{white}{\textbf{Crit\`ere}} &
\textcolor{white}{\textbf{Moodle}} &
...
%% ── CRITÈRE 1 ──────────────────────────────────────────────────────────
\rowcolor{ustolightblue!40}
Adaptation au contexte alg\'erien &
Moyenne &
Faible &
Tr\`es \'elev\'ee \\
\hline
...
\noindent{\small\textit{Sources~: \cite{moodle_overview_2026,google_classroom_2026}}}

\subsection{Synth\`ese et bilan de l'\'etat de l'art}

L'analyse comparative men\'ee dans le tableau~\ref{tab:compar_detail} d\'emontre de mani\`ere univoque que les plateformes g\'en\'eralistes mondiales ne r\'epondent que tr\`es partiellement aux imp\'eratifs du paysage \'educatif national. Si Moodle offre un niveau de personnalisation satisfaisant, son co\^ut indirect de d\'eploiement reste moyen et son adaptation par d\'efaut au contexte alg\'erien demeure limit\'ee. De son c\^ot\'e, Google Classroom privil\'egie la gratuit\'e et int\`egre la langue arabe, mais souffre d'une rigidit\'e logicielle (faible personnalisation) et pose un d\'efi majeur en mati\`ere de souverainet\'e technique puisqu'un h\'ebergement local s'av\`ere impossible. De surcro\^it, aucune de ces solutions ne prend en charge nativement la gestion sp\'ecifique des centres de soutien scolaire ni une assistance IA h\'eberg\'ee localement.

Ces lacunes majeures l\'egitiment pleinement le d\'eveloppement d'EduPlatform (TAMKIN). Con\c{c}ue sp\'ecifiquement pour s'ins\'erer dans l'\'ecosyst\`eme alg\'erien, notre solution garantit la souverainet\'e de l'institution gr\^ace \`a un h\'ebergement local effectif et un support natif et bilingue de la langue arabe. L'introduction d'un assistant IA local d\'epourvu de d\'ependances cloud ext\'erieures, coupl\'ee \`a des modules d\'edi\'es aux structures de soutien et \`a un co\^ut d'exploitation r\'eduit, conf\`ere \`a TAMKIN une valeur ajout\'ee unique qu'aucune solution logicielle standard ne peut actuellement revendiquer sur le march\'e.
%%──────────────────────────────────────────────────────────────────────────────
\section{Positionnement de TAMKIN}
\label{sec:positionnement}
%%──────────────────────────────────────────────────────────────────────────────

TAMKIN se positionne comme une plateforme acad\'emique int\'egr\'ee, r\'eunissant dans un seul environnement les fonctions p\'edagogiques, sociales et organisationnelles que les solutions existantes dispersent entre plusieurs outils. Son architecture repose sur quatre piliers structurants~:
...
\begin{itemize}
  ...
  \item \textbf{Gouvernance par r\^oles~:} le syst\`eme d'autorisation \`a cinq niveaux (Administrateur Super, Administrateur d'etablissement, Formateur Principal, Formateur Simple, Utilisateur) garantit la s\'ecurit\'e, la modulation des acc\`es et la responsabilit\'e de chaque acteur.
...
Ce premier chapitre a \'etabli le cadre analytique et conceptuel du projet TAMKIN en articulant trois niveaux de lecture compl\'ementaires~: le contexte mondial de la transformation num\'erique de l'enseignement, les besoins sp\'ecifiques du contexte acad\'emique local de l'USTO-MB, et le positionnement de TAMKIN par rapport aux solutions existantes.

L'analyse comparative men\'ee dans la section~\ref{sec:etat_art} d\'emontre qu'aucune des plateformes \'etudi\'ees~--- Moodle, Google Classroom, Microsoft Teams Education, Canvas~--- ne couvre de mani\`ere optimale l'ensemble des exigences identifi\'ees~: navigation module-first, gouvernance \`a cinq r\^oles, communication int\'egr\'ee et planification hebdomadaire d\'edi\'ee. Cette convergence de lacunes justifie pleinement la conception de TAMKIN comme solution \textit{ad hoc}, d\'evelopp\'ee sp\'ecifiquement pour le contexte éducatif local.

La suite du m\'emoire approfondit successivement la conception UML (Chapitre~2), l'impl\'ementation technique (Chapitre~3) et l'\'évaluation des r\'esultats (Chapitre~4), en s'appuyant sur le cadre th\'eorique et m\'ethodologique pos\'e dans le pr\'esent chapitre. Cette analyse vise notamment les besoins des etablissements.

%% ═══════════════════════════════════════════════════════════════════════════════
%% CHAPITRE 2 — Analyse, modelisation UML et conception
%% ═══════════════════════════════════════════════════════════════════════════════

\chapter{Analyse des besoins, architecture et conception UML de la solution}

%%──────────────────────────────────────────────────────────────────────────────
\section{Introduction du chapitre}
%%──────────────────────────────────────────────────────────────────────────────

Ce chapitre formalise la traduction de la problématique metier en specifications exploitables pour la realisation logicielle. Il presente successivement l'analyse des besoins, la modelisation UML des interactions, la conception des données et les choix architecturaux retenus pour TAMKIN.
...
\begin{itemize}
  \item \textbf{Administrateur super}: gouvernance plateforme, écoles, administrateurs;
  \item \textbf{Administrateur d'etablissement}: gestion des utilisateurs, modules, assignations, inscriptions;
  \item \textbf{Formateur principal}: publication des ressources, suivi des apprenants, sessions live;
...
\begin{figure}[H]
    \centering
    \safeimage[0.65\textwidth]{usecase-admin.png}{Cas d’utilisation: Administrateur}{Cas d’utilisation: Administrateur}
...
\begin{figure}[H]
    \centering
    \safeimage[0.65\textwidth]{usecase-forma.png}{Cas d’utilisation: Formateur}{Cas d’utilisation: Formateur}
...
\begin{figure}[H]
    \centering
    \safeimage[0.65\textwidth]{studentusecase.png}{Cas d'utilisation: Etudiant}{Cas d'utilisation: Etudiant}
    \label{fig:usecase-etudiant}
  \end{figure}
\clearpage
...
\textbf{Participants:} Etudiant, Admin Ecole, Super Admin, Formateur, Syst\`eme TAMKIN.
...
\textbf{Participants:} Super Admin, Syst\`eme TAMKIN.
...
\textbf{Participants:} Etudiant, Admin Ecole, Syst\`eme TAMKIN.
...
\textbf{Participants:} Formateur, Syst\`eme TAMKIN.
...
\textbf{Participants:} Formateur, Etudiant, Syst\`eme TAMKIN.
...
Le modèle conceptuel s'articule autour des tables PostgreSQL et des contraintes qui structurent le schéma relationnel de TAMKIN. Dans l'implémentation, les classes logiques se traduisent par des tables, des clés primaires, des clés étrangères et des règles d'intégrité gérées par PostgreSQL.

\begin{itemize}
  \item \texttt{users} : comptes utilisateurs, rôles, informations personnelles, niveau et indicateurs de progression.
  \item \texttt{modules} : unités pédagogiques avec code, nom, niveau, catégorie et créateur.
  \item \texttt{formateur\_module\_assignment} : table d'association formateur-module, identifiant les formateurs principaux et secondaires.
  \item \texttt{etudiant\_module\_enrollment} : table d'association étudiant-module, avec statut et horodatage.
  \item \texttt{ressource\_pedagogique} : ressources liées à un module, déposées par un utilisateur.
  \item \texttt{communities} / \texttt{community\_members} : communauté collaborative et ses adhésions.
  \item \texttt{conversations} / \texttt{conversation\_participants} / \texttt{messages} : structure de communication et participation en chat.
  \item \texttt{badges} / \texttt{student\_badges} / \texttt{student\_levels} / \texttt{student\_progress} : tables de gamification et de suivi.
  \item \texttt{notifications}, \texttt{password\_reset\_tokens}, \texttt{categories} et \texttt{xp\_rules} : tables de support pour la sécurité, les alertes et la configuration.
\end{itemize}

\begin{figure}[H]
    \centering
    \safeimage[0.8\textwidth]{umldiagclasse.drawio.png}{Diagramme de classes TAMKIN}{Diagramme de classes TAMKIN}
...
Le modèle conceptuel des données de TAMKIN met en évidence les entités principales et leurs associations. Dans PostgreSQL, ce modèle est matérialisé par des tables relationnelles, des clés primaires et des clés étrangères qui assurent la cohérence des relations métier.

Les entités les plus importantes sont :
\begin{itemize}
  \item \textbf{Utilisateur} : table \texttt{users} avec rôle, niveau académique, présence et progression.
  \item \textbf{Module} : table \texttt{modules} qui regroupe les informations pédagogiques et la catégorie.
  \item \textbf{Affectation de formateur} : table d'association \texttt{formateur\_module\_assignment} liée à \texttt{users} et \texttt{modules} par des contraintes \texttt{FOREIGN KEY}.
  \item \textbf{Inscription étudiante} : table d'association \texttt{etudiant\_module\_enrollment} avec statut d'inscription.
  \item \textbf{Ressource pédagogique} : table \texttt{ressource\_pedagogique} liée à un module et à l'utilisateur qui l'a déposée.
  \item \textbf{Communauté} : table \texttt{communities} et table associée \texttt{community\_members} pour les adhésions.
  \item \textbf{Conversation} et \textbf{Message} : tables \texttt{conversations}, \texttt{conversation\_participants} et \texttt{messages} pour le chat.
  \item \textbf{Progression et badges} : tables \texttt{student\_levels}, \texttt{student\_badges} et \texttt{student\_progress} pour suivre les acquis et les récompenses.
\end{itemize}

Le MCD se traduit par des cardinalités conformes à PostgreSQL :
\begin{itemize}
  \item \texttt{users} 0..* ↔ 0..* \texttt{communities} via \texttt{community\_members}.
  \item \texttt{users} 0..* ↔ 0..* \texttt{conversations} via \texttt{conversation\_participants}.
  \item \texttt{modules} 1..1 ↔ 0..* \texttt{formateur\_module\_assignment}.
  \item \texttt{modules} 1..1 ↔ 0..* \texttt{etudiant\_module\_enrollment}.
  \item \texttt{modules} 1..1 ↔ 0..* \texttt{ressource\_pedagogique}.
  \item \texttt{conversations} 1..1 ↔ 0..* \texttt{messages}.
  \item \texttt{users} 1..1 ↔ 0..* \texttt{notifications}.
  \item \texttt{categories} 0..* ↔ 0..1 \texttt{modules}.
\end{itemize}

\subsection{Modèle logique des données (MLD)}

Le passage du MCD au MLD normalisé a été réalisé en conservant l'intégrité des relations tout en évitant les redondances. Dans PostgreSQL, les tables sont organisées avec des clés primaires auto-incrémentées (séquences) et des clés étrangères garantissant les associations.

Les contraintes clés mises en œuvre sont :
\begin{itemize}
  \item clés primaires sur chaque colonne \texttt{id} ;
  \item clés étrangères reliant \texttt{module\_id}, \texttt{user\_id}, \texttt{community\_id}, \texttt{conversation\_id}, \texttt{resource\_id}, \texttt{badge\_id} et \texttt{category\_id} aux tables cibles ;
  \item contraintes d'unicité empêchant les doublons dans \texttt{community\_members} et \texttt{conversation\_participants} ;
  \item \texttt{ON DELETE CASCADE} pour propager les suppressions sur les tables dépendantes ;
  \item \texttt{ON DELETE SET NULL} pour les relations optionnelles telles que \texttt{modules.category\_id} et \texttt{conversations.created\_by}.
\end{itemize}

Le MLD principal comprend notamment :
\begin{itemize}
  \item \texttt{users} pour les comptes, les rôles et le suivi d'activité ;
  \item \texttt{modules} pour les unités pédagogiques ;
  \item \texttt{formateur\_module\_assignment} pour l'affectation des formateurs aux modules ;
  \item \texttt{etudiant\_module\_enrollment} pour l'inscription des étudiants aux modules ;
  \item \texttt{ressource\_pedagogique} pour le dépôt et la gestion des fichiers pédagogiques ;
  \item \texttt{communities} et \texttt{community\_members} pour les espaces collaboratifs ;
  \item \texttt{conversations}, \texttt{conversation\_participants} et \texttt{messages} pour le chat ;
  \item \texttt{badges}, \texttt{student\_badges}, \texttt{student\_levels} et \texttt{student\_progress} pour le suivi et la gamification ;
  \item \texttt{notifications}, \texttt{password\_reset\_tokens}, \texttt{categories} et \texttt{xp\_rules} pour la configuration, les alertes et la sécurité.
\end{itemize}

La vue \texttt{student\_enrollments\_view} facilite les requêtes de consultation du parcours étudiant sans dupliquer les données du schéma relationnel.


\subsection{Dictionnaire de données}

Le dictionnaire de données regroupe les tables les plus significatives du système et leurs rôles.

\renewcommand{\arraystretch}{1.15}
\begin{longtable}{|p{3.4cm}|p{4.4cm}|p{4.4cm}|}
\caption{Dictionnaire de données principal}\label{tab:dictionnaire_donnees}\\
\hline
\rowcolor{ustoblue}
\textcolor{white}{\textbf{Table}} & \textcolor{white}{\textbf{Description}} & \textcolor{white}{\textbf{Champs principaux}} \\
\hline
\endfirsthead
...
users & Comptes utilisateurs multi-rôles & id, matricule, email, password\_hash, google\_id, nom, prenom, role\_global, niveau, is\_active, total\_xp, current\_level \\
\hline
modules & Unités pédagogiques ciblées par les parcours & id, code, nom, description, niveau, credits, coeff, components, category\_id, xp\_reward \\
\hline
formateur\_module\_assignment & Affectation des formateurs aux modules & id, formateur\_id, module\_id, assigned\_by, assigned\_at, is\_primary \\
\hline
etudiant\_module\_enrollment & Inscription d'un étudiant à un module & id, etudiant\_id, module\_id, enrolled\_at, status \\
\hline
ressource\_pedagogique & Ressources pédagogiques déposées par module & id, module\_id, uploaded\_by, titre, category, file\_path, file\_name, file\_size, created\_at \\
\hline
communities & Espaces collaboratifs liés aux modules ou catégories & id, name, slug, description, category\_id, member\_count, created\_by, is\_active \\
\hline
community\_members & Participation d'un utilisateur à une communauté & id, community\_id, user\_id, role, joined\_at, last\_active \\
\hline
conversations & Conversations de chat privées ou communautaires & id, conversation\_type, community\_id, created\_by, last\_message, message\_count \\
\hline
conversation\_participants & Membres d'une conversation et lecture des messages & id, conversation\_id, user\_id, joined\_at, last\_read\_at, role, is\_muted \\
\hline
messages & Messages échangés dans les conversations & id, conversation\_id, user\_id, content, created\_at, updated\_at \\
\hline
notifications & Notifications envoyées aux utilisateurs & id, user\_id, type, title, content, link, is\_read \\
\hline
password\_reset\_tokens & Jetons de réinitialisation de mot de passe & id, user\_id, token, expires\_at, used \\
\hline
badges & Définitions des badges et conditions d'obtention & id, name, description, icon, xp\_required, modules\_completed\_required \\
\hline
student\_badges & Badges attribués aux étudiants & id, student\_id, badge\_id, awarded\_at \\
\hline
student\_levels & Statut de progression de l'étudiant & id, student\_id, current\_level, total\_xp, resources\_completed, modules\_completed, current\_streak \\
\hline
student\_progress & Suivi détaillé des activités de l'étudiant & id, student\_id, module\_id, resource\_id, status, progress\_percentage, last\_accessed\_at \\
\hline
categories & Catégories de modules et de communautés & id, name, slug, description, icon, color, display\_order \\
\hline
xp\_rules & Règles de points d'expérience par action & id, action\_type, xp\_points \\
\hline
\end{longtable}

\subsection{Schéma relationnel complet}

Le schéma relationnel complet de TAMKIN est organisé autour des relations principales suivantes :
\begin{itemize}
  \item \texttt{users} \(1,n\) \texttt{formateur\_module\_assignment} et \texttt{etudiant\_module\_enrollment} ;
  \item \texttt{modules} \(1,n\) \texttt{ressource\_pedagogique} ;
  \item \texttt{communities} \(1,n\) \texttt{community\_members} ;
  \item \texttt{conversations} \(1,n\) \texttt{conversation\_participants} et \texttt{messages} ;
  \item \texttt{messages} \(1,n\) \texttt{message\_reactions} ;
  \item \texttt{users} \(1,n\) \texttt{notifications} et \texttt{password\_reset\_tokens} ;
  \item \texttt{users} \(1,n\) \texttt{student\_levels} et \texttt{student\_progress} ;
  \item \texttt{badges} \(1,n\) \texttt{student\_badges}.
\end{itemize}

Ce schéma relationnel complet est implémenté dans la base de données PostgreSQL de l'application. Il structure les flux pédagogiques, collaboratifs et de gamification de TAMKIN tout en assurant l'intégrité référentielle et la normalisation des données.
...
\begin{enumerate}
  ...
  \begin{figure}[H]
    \centering
    \safeimage[0.8\textwidth]{Capture d’écran (372).png}{Vue Administrateur d'Ecole: Ajout de module}{Vue Administrateur d'Ecole: Ajout de module}
    \label{fig:view-adminmodule}
\end{figure}
  ...
  \begin{figure}[H]
    \centering
    \safeimage[0.8\textwidth]{Capture d’écran (373).png}{Vue Administrateur d'Ecole: Affectation de formateur}{Vue Administrateur d'Ecole: Affectation de formateur}
    \label{fig:view-adminmodule}
\end{figure}
  \item l'administrateur affecte un formateur principal (chargé de formation) et éventuellement des formateurs simples;
  \begin{figure}[H]
    \centering
    \safeimage[0.8\textwidth]{Capture d’écran (374).png}{Vue Formateur: Modules}{Vue Formateur: Modules}
    \label{fig:view-adminmodule}
\end{figure}
...
\begin{enumerate}
  ...
  \begin{figure}[H]
    \centering
    \safeimage[0.9\textwidth]{Capture d’écran (375).png}{Vue Formateur: Modules}{Vue Formateur: Modules}
    \label{fig:view-adminmodule}
\end{figure}
\begin{figure}[H]
    \centering
    \safeimage[0.9\textwidth]{Capture d’écran (376).png}{Vue Formateur: Ajout ressource}{Vue Formateur: Ajout ressource}
    \label{fig:view-adminmodule}
\end{figure}
\end{enumerate}
...
\begin{enumerate}
  ...
  \begin{figure}[H]
    \centering
    \safeimage[0.9\textwidth]{Capture d’écran (378).png}{Formulaire d'inscription}{Formulaire d'inscription}
    \label{fig:view-inscription-form}
\end{figure}
  \item la demande d'inscription est envoyée et traitée par l'administrateur de l'école;
  \begin{figure}[H]
    \centering
    \safeimage[0.9\textwidth]{Capture d’écran (379).png}{Vue Admin d'Ecole: Inscriptions}{Vue Admin d'Ecole: Inscriptions}
...
\begin{enumerate}
  ...
  \begin{figure}[H]
    \centering
    \safeimage[0.8\textwidth]{Capture d’écran (380).png}{Vue Etudiant: Assistant IA}{Vue Etudiant: Assistant IA}
...
\begin{enumerate}
  ...
  \begin{figure}[H]
    \centering
    \safeimage[0.8\textwidth]{Capture d’écran (381).png}{Vue Formateur: Live}{Vue Formateur: Live}
...
\end{figure}
  ...
  \begin{figure}[H]
    \centering
    \safeimage[0.8\textwidth]{Capture d’écran (382).png}{Vue Etudiant: Acceuil}{Vue Etudiant: Acceuil}
    \label{fig:view-etudiant-accueil}
\end{figure}
...
\hline
OS3 & Communication integree & Apprendre et interagir & Chat et publication de ressources operationnels \\
\hline
...
Apres la phase d'analyse et de conception, ce chapitre presente la realisation effective de TAMKIN. Il decrit l'environnement de développement, l'implementation des modules fonctionnels, l'intégration de la fonctionnalite live, puis les tests de validation.
...
Le fonctionnement de TAMKIN repose sur une separation claire des environnements de développement et de production.
\begin{itemize}
...
Les utilisateurs disposent d'espaces de communication (chat privé et de groupe) et de publication de ressources pédagogiques afin de fluidifier les interactions pédagogiques et l'entraide.
...
La realisation confirme la faisabilite technique du socle TAMKIN et sa capacite a supporter des usages reels multi-acteurs. Les evolutions prioritaires envisagees sont:
\begin{itemize}
...
Dans les chapitres precedents, nous avons expose le contexte, la problématique, puis les choix techniques et fonctionnels qui structurent la plateforme TAMKIN. Le present chapitre deplace l'analyse vers la viabilite entrepreneuriale du projet. L'objectif est de verifier que la proposition de valeur n'est pas uniquement techniquement realisable, mais egalement economiquement soutenable dans un contexte de startup EdTech.
...
Le positionnement de TAMKIN ne se limite pas a une comparaison fonctionnelle avec les LMS etablis. Il repose sur une strategie de specialisation locale, orientee gouvernance pédagogique et simplicite d'usage.
...
Les concurrents generalistes couvrent un spectre large, mais avec une adaptation locale limitee. TAMKIN se differencie sur:
\begin{itemize}
...
\hline
TAMKIN & Elevee & Native au contexte metier & Proximite + iteration \\
\hline
\end{tabular}
\end{table}

%%──────────────────────────────────────────────────────────────────────────────
\section{Business Model Canvas de TAMKIN}
%%──────────────────────────────────────────────────────────────────────────────
...
TAMKIN cible quatre segments prioritaires:
\begin{itemize}
...
\caption{Synthese du Business Model Canvas de TAMKIN}
...
L'évaluation stratégique de la solution TAMKIN repose sur une analyse SWOT (Strengths, Weaknesses, Opportunities, Threats) complète. Cette approche méthodologique permet de confronter les facteurs internes propres à la conception de la plateforme aux dynamiques externes de l'écosystème éducatif et entrepreneurial algérien.

\begin{table}[htbp]
\centering
\caption{Matrice SWOT synthétique de la plateforme TAMKIN}
\label{tab:matrice_swot}
\begin{tabularx}{\textwidth}{|X|X|}
\hline
\cellcolor{gray!15}\textbf{Forces (Strengths)} & \cellcolor{gray!15}\textbf{Faiblesses (Weaknesses)} \\
\small
\begin{itemize}
    \item Solution locale et souveraine.
    \item Interface unique et centralisée.
    \item Architecture moderne (React/Node).
    \item Assistant IA pédagogique intégré.
    \item Bilinguisme natif (Arabe/Français).
\end{itemize}
& 
\small
\begin{itemize}
    \item Stade de PFE (manque de recul).
    \item Budget de départ limité.
    \item Équipe technique réduite.
    \item Absence d'application mobile native en v1.
    \item Notoriété initiale inexistante.
\end{itemize} \\
\hline
\cellcolor{gray!15}\textbf{Opportunités (Opportunities)} & \cellcolor{gray!15}\textbf{Menaces (Threats)} \\
\small
\begin{itemize}
    \item Transformation numérique en Algérie.
    \item Boom des centres de soutien et du privé.
    \item Cadre étatique favorable aux startups (12-75).
    \item Demande accrue pour la langue arabe.
    \item Marché EdTech national non saturé.
\end{itemize}
& 
\small
\begin{itemize}
    \item Concurrence des géants (Moodle, Teams).
    \item Résistance culturelle au changement.
    \item Disparités régionales de connectivité Internet.
    \item Modèles gratuits des GAFAM.
    \item Risques liés à la cybersécurité.
\end{itemize} \\
\hline
\end{tabularx}
\end{table}

\paragraph{Analyse détaillée des facteurs :}

\begin{description}
    \item[Forces (S) :] Facteurs internes positifs qui procurent un avantage concurrentiel à la solution :
    \begin{itemize}
        \item \textbf{Solution développée localement :} Parfaitement adaptée aux spécificités, aux besoins réels et aux exigences réglementaires des établissements algériens.
        \item \textbf{Centralisation des services :} Une interface unique qui regroupe la gestion des cours, le partage des ressources, les outils de communication et le déploiement de classes virtuelles.
        \item \textbf{Architecture technique moderne :} Utilisation d'une pile technologique robuste, hautement évolutive et standardisée (React, Node.js, PostgreSQL).
        \item \textbf{Innovation par l'IA :} Intégration native d'un assistant IA pédagogique fonctionnant localement, offrant un tutorat personnalisé.
        \item \textbf{Avantage économique :} Coût global d'acquisition, de déploiement et de maintenance nettement inférieur aux solutions étrangères payantes.
        \item \textbf{Bilinguisme natif :} Prise en charge fluide et simultanée des langues Arabe et Français, respectant l'usage du système éducatif national.
        \item \textbf{Souveraineté des données :} Choix exclusif d'un hébergement local, garantissant la sécurité et la confidentialité des données éducatives sensibles.
        \item \textbf{Flexibilité structurelle :} Grande facilité de personnalisation permettant de configurer la plateforme selon la typologie de l'établissement (école, université ou centre privé).
    \end{itemize}

    \item[Faiblesses (W) :] Limites internes actuelles qu'il conviendra de surmonter lors du passage à l'échelle :
    \begin{itemize}
        \item \textbf{Stade de maturité initial :} Projet encore positionné au niveau de Projet de Fin d'Études (PFE), manquant de retours d'expérience et de métriques en production réelle.
        \item \textbf{Contraintes financières :} Budget initial très restreint dédié à la phase d'industrialisation, de déploiement d'infrastructure et de commercialisation.
        \item \textbf{Ressources humaines limitées :} Forte dépendance stratégique et opérationnelle vis-à-vis d'une équipe technique très réduite au démarrage.
        \item \textbf{Limitation des données IA :} Manque de jeux de données réels et massifs en début de projet pour entraîner et personnaliser finement les modèles d'apprentissage de l'IA.
        \item \textbf{Déficit de visibilité :} Notoriété de marque inexistante sur le marché au moment du lancement de l'activité commerciale.
        \item \textbf{Validation de charge restreinte :} Expérimentations techniques limitées concernant le comportement de l'infrastructure face à un très grand nombre d'utilisateurs simultanés.
        \item \textbf{Périmètre applicatif v1 :} Absence d'une application mobile native au lancement (la version 1 reposant exclusivement sur une interface Web responsive).
        \item \textbf{Maintenance critique :} Nécessité impérative d'assurer un support technique continu de haute disponibilité, complexe à garantir avec une structure restreinte.
    \end{itemize}

    \item[Opportunités (O) :] Tendances de l'environnement externe que la startup peut exploiter à son avantage :
    \begin{itemize}
        \item \textbf{Modernisation sectorielle :} Accélération globale de la transformation numérique au sein du secteur éducatif public et privé en Algérie.
        \item \textbf{Essor du secteur privé :} Croissance exponentielle et structuration continue des établissements privés et des centres de soutien scolaire.
        \item \textbf{Nouvelles pratiques pédagogiques :} Développement massif et irréversible de l'enseignement hybride et des modèles de formation à distance.
        \item \textbf{Appétence pour l'innovation :} Intégration et intérêt institutionnel grandissant pour l'introduction des technologies de l'intelligence artificielle dans l'éducation.
        \item \textbf{Ancrage universitaire :} Perspectives de partenariats scientifiques et stratégiques avec les universités, les laboratoires de recherche et les incubateurs algériens.
        \item \textbf{Cadre réglementaire incitatif :} Soutien gouvernemental fort accordé aux startups innovantes, notamment via les mécanismes de la loi et du décret 12-75.
        \item \textbf{Valorisation de la langue nationale :} Demande croissante pour des plateformes performantes conçues d'origine en langue arabe, secteur souvent délaissé par les outils occidentaux.
        \item \textbf{Dynamique du marché :} Écosystème EdTech national encore jeune, émergent et peu saturé par des acteurs locaux structurés.
    \end{itemize}

    \item[Menaces (T) :] Risques et barrières externes que le projet doit anticiper et contourner :
    \begin{itemize}
        \item \textbf{Pression concurrentielle :} Présence frontale d'acteurs internationaux massivement installés et standardisés (Moodle, Google Classroom, Microsoft Teams).
        \item \textbf{Inertie culturelle :} Résistance psychologique ou administrative au changement de la part de certains décideurs, enseignants ou parents d'élèves.
        \item \textbf{Évolution technologique rapide :} Obsolescence accélérée propre au secteur de l'EdTech, imposant un cycle de R\&D très court et coûteux.
        \item \textbf{Exigences de sécurité :} Risques croissants liés à la cybersécurité et obligations strictes concernant la protection des données personnelles.
        \item \textbf{Mondialisation des offres :} Pénétration agressive potentielle de nouvelles solutions EdTech internationales ciblant les marchés émergents.
        \item \textbf{Infrastructures réseau :} Disparités régionales majeures concernant la qualité de l'accès à Internet à haut débit, pouvant freiner l'adoption de la plateforme.
        \item \textbf{Stratégies de gratuité :} Positionnement agressif d'offres gratuites, d'essais prolongés ou de solutions subventionnées par les géants du numérique (GAFAM).
        \item \textbf{Acquisition client :} Importante barrière à l'entrée pour convaincre, contractualiser et fidéliser les premiers clients institutionnels de référence.
    \end{itemize}
\end{description}
%%──────────────────────────────────────────────────────────────────────────────
...
L'analyse entrepreneuriale montre qu'TAMKIN dispose d'une base solide pour evoluer d'un projet académique vers une startup EdTech viable. Le Business Model Canvas met en evidence un positionnement clair B2B2C, tandis que la SWOT confirme une fenetre d'opportunite réelle, a condition de structurer rapidement les dimensions commerciales, organisationnelles et securitaires.
...
Sur le plan technique, TAMKIN propose un socle coherent et operationnel: gestion multi-roles, administration pédagogique, structuration des contenus par composants (Cours/TD/TP), communication integree, suivi et fonctionnalite live. Les tests fonctionnels ont confirme la stabilite des parcours critiques pour les profils administrateur, formateur et étudiant.

Sur le plan methodologique, la structuration du mémoire s'aligne sur les references d'encadrement (branding et bibliotheque virtuelle), tout en introduisant une extension majeure: la dimension entrepreneuriale. Le chapitre dedie au modele économique et a l'analyse SWOT montre qu'TAMKIN peut evoluer d'un projet académique vers une startup EdTech viable, sous reserve d'une execution disciplinee sur les axes produit, commercial et operationnel.
...
En synthese, TAMKIN demontre qu'une solution locale, évolutive et orientee usages peut concilier rigueur académique, efficacite operationnelle et potentiel de croissance startup.
