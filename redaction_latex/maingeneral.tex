...
\begin{center}
\lairge
\textit{\`A mes parents, pour leur amour et leur soutien.}
\medskip

\textit{\`A mes amis et coll\`egues, pour leurs encouragements et leurs conseils.}
\end{center}
\vspace{1cm}
\noindent Ce m\'emoire est aussi d\'edi\'e \`a tous ceux qui ont partag\'e leurs connaissances et leur temps pour m'aider.
\clearpage

\thispagestyle{empty}
\chapter*{Remerciements}
\addcontentsline{toc}{chapter}{Remerciements}
\noindent Je remercie vivement mon encadrant pour son suivi, ses conseils et sa rigueur, ainsi que les membres du jury pour leurs remarques constructives.

\smallskip
\noindent Mes remerciements vont \`a l'Equipe pédagogique, au personnel administratif, \`a mes coll\`egues et \`a ma famille pour leur soutien moral et logistique.
\clearpage
...
Canvas est un LMS cloud moderne, appr\'eci\'e pour son interface structur\'ee, ses workflows d'\'evaluation et ses outils analytiques. Son adoption est pr\'edominante dans les établissements d'enseignement nord-am\'ericains~\cite{canvas_overview_2026}.
...
\begin{itemize}
  ...
  \item EduPlatform est la seule solution \textbf{gratuite}, \textbf{auto-h\'eberg\'ee} et \textbf{contexte-native}~: chaque fonctionnalit\'e a \'et\'e con\c{c}ue en r\'eponse directe \`a un besoin identifi\'e dans un contexte éducatif local.
...
La suite du m\'emoire approfondit successivement la conception UML (Chapitre~2), l'impl\'ementation technique (Chapitre~3) et l'\'evaluation des r\'esultats (Chapitre~4), en s'appuyant sur le cadre th\'eorique et m\'ethodologique pos\'e dans le pr\'esent chapitre. Cette analyse vise notamment les besoins des écoles de soutien, des écoles de langues et des centres de formation. Cette analyse vise notamment les besoins des écoles de soutien, des écoles de langues et des centres de formation.
...
\begin{itemize}
  ...
  \item \textbf{Formateur}: publication des ressources, suivi des apprenants, sessions live;
...
\begin{itemize}
  \item ecoles, centres de formation et etablissements de soutien cherchant une plateforme pedagogique gouvernee;
...
Ce memoire avait pour objectif de concevoir et realiser une plateforme pedagogique unifiee repondant aux besoins d'un contexte éducatif reel. La demarche adoptee a permis de couvrir l'ensemble de la chaine de valeur du projet: analyse du contexte, modelisation, implementation technique, validation fonctionnelle et projection startup.
